    ...
    <>
      ...
      <div className="brutal-card bg-[var(--card-bg)] p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block font-mono text-xs font-bold mb-2">LinkedIn</label>
            <input
              type="url"
          ...
          <div>
            <label className="block font-mono text-xs font-bold mb-2">Portfolio URL</label>
            <input
              type="url"
      ...
      <div className="mt-4">
        <label className="block font-mono text-xs font-bold mb-2">Additional Information</label>
        <textarea
      ...
      <div className="brutal-card bg-[var(--card-bg)] p-6">
        ...
        <div className="flex gap-2 mb-3">
          <input
            ...
            onChange={(e) =>
              setManualFormData({ ...manualFormData, certificationInput: e.target.value })
            }
            onKeyPress={(e) => {
              if (e.key === "Enter") {
                e.preventDefault();
      ...
      <div className="brutal-card bg-[var(--card-bg)] p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input
            ...
            onChange={(e) => handleEducationDraftChange("institutionName", e.target.value)}
          ...
          <input
            ...
            onChange={(e) => handleEducationDraftChange("certification", e.target.value)}
          ...
          <input
            ...
            onChange={(e) => handleEducationDraftChange("durationFrom", e.target.value)}
          ...
          <input
            ...
            onChange={(e) => handleEducationDraftChange("durationTo", e.target.value)}
            placeholder="To (e.g., 2022 or Present)"
            className="border-2 border-[var(--border-color)] bg-[var(--bg)] text-[var(--fg)] px-3 py-2 font-mono text-sm outline-none focus:border-[var(--yellow)]"
          />
          <textarea
            value={manualFormData.educationDraft?.summary || ""}
            onChange={(e) => handleEducationDraftChange("summary", e.target.value)}
        ...
        <div className="mt-4 space-y-3">
          {(manualFormData.education || []).map((edu, i) => (
            <div key={i} className="brutal-card bg-[var(--bg)] border-2 border-[var(--border-color)] p-3">
              <div className="flex items-start justify-between gap-3">
                <div>
                  ...
                  {edu.summary && (
                    <p className="font-mono text-xs mt-2 text-[var(--fg-muted)]">{edu.summary}</p>
                  )}
                </div>
                <button
                  type="button"
      ...
      <div className="flex gap-4">
        <button
          ...
          style={{
            background: submitting ? "var(--fg-muted)" : "var(--yellow)",
            color: "#0a0a0a",
          }}
        >
          {submitting && <Loader size={16} className="animate-spin" />}
          {submitting ? "Analyzing..." : isEdit ? "Analyze & Update" : "Analyze & Submit"}
        </button>
        <button
